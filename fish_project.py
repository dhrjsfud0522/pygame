...
class Pipe():
    def __init__(self):
        ...
        self.pipe_choice = random.choice(spipes)
        self.spipe = pygame.image.load(os.path.join(assets_path, self.pipe_choice))
    ...
    def set_pos(self):
        ...
        if self.random_pipe == 1:
            ...
            self.lpipe_rect.y = -2
            if self.pipe_choice == "pipe02.png" or self.pipe_choice == "pipe03.png":
                self.spipe_rect.x = SC_w
            elif self.pipe_choice == "pipe04.png":
                self.spipe_rect.x = SC_w - 50
            elif self.pipe_choice == "pipe05.png":
                self.spipe_rect.x = SC_w - 40
            elif self.pipe_choice == "pipe06.png":
                self.spipe_rect.x = SC_w - 15
    ...
    def update(self):
        self.lpipe_rect.x -= 15
        self.spipe_rect.x -= 15
    def out_of_screen(self):
        if self.lpipe_rect.x + self.lpipe_width <= 0:
            return True
        return False
