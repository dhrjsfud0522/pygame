...
class Game():
    ...
    def display_menu(self, screen):
        ...
        self.draw_text(screen, 'spaceship',
                       self.font_70, draw_x, draw_y, WHITE)
        self.draw_text(screen, 'score: {}'.format(self.score),
                       self.font_30, draw_x, draw_y + 100, YELLOW)
        self.draw_text(screen, "press the mouse button to start the game",
    ...
    def display_frame(self, screen):
        ...
        self.draw_text(screen, 'warp: {}'.format(self.warp_count),
